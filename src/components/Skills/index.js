    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          the different Atlassain tools, creating new macros in JIRA and Confluence, and updating the knowledge base.
          ...
          <p>
            ...
            are a <a href='https://rhythmic-rights.vercel.app/' target='_blank' rel='noreferrer'>Audio Minting NFT</a> website, 
            an <a href='https://github.com/rvdang256/Article-Of-Clothing-Classifier' target='_blank' rel='noreferrer'>Article of Clothing Classifier</a>, 
            and a <a href='https://cmpsc-263-project-1.vercel.app/' target='_blank' rel='noreferrer'>Calorie Tracker</a> website. To see more of my projects, please
